...
__all__ = [
    'DISPID_SLWsCount', 'DISPID_SPPId', 'SP_VISEME_7',
    'SWPUnknownWordPronounceable', 'SAFT22kHz16BitMono',
    'SAFT48kHz16BitMono', 'DISPID_SRRDiscardResultInfo',
    'DISPID_SPCLangId', 'ISpResourceManager', 'SPPS_LMA',
    'SAFT22kHz16BitStereo', 'SPGRAMMARWORDTYPE', 'SECFIgnoreKanaType',
    'DISPID_SASCurrentSeekPosition', 'SVSFIsXML', 'SAFT48kHz8BitMono',
    'DISPID_SRIsUISupported', 'DISPID_SRCEPropertyStringChange',
    'DISPID_SRGState', 'DISPID_SPRuleId', 'DISPID_SRCEventInterests',
    'DISPID_SRCEHypothesis', 'DISPID_SPRuleNumberOfElements',
    'STCRemoteServer', 'SPAO_NONE', 'DISPID_SABufferNotifySize',
    'SpeechEmulationCompareFlags', 'DISPID_SDKEnumValues',
    'DISPID_SGRSTsCount', 'SAFTCCITT_uLaw_11kHzStereo', 'SPVPRI_OVER',
    'SpeechAllElements', 'ISpeechAudioStatus', 'SPWT_DISPLAY',
    'DISPID_SpeechLexiconWord', 'SGSEnabled', 'SVSFParseAutodetect',
    'SPSHT_EMAIL', 'SPEI_MAX_SR', 'DISPID_SLWLangId', 'WAVEFORMATEX',
    'SPPHRASERULE', 'SPVPRI_ALERT', 'eLEXTYPE_RESERVED7',
    'SpeechVoiceEvents', 'ISpeechLexiconWords', 'ISpSerializeState',
    'SpVoice', 'DISPID_SpeechPhraseAlternates', 'SPFM_OPEN_READONLY',
    'Speech_StreamPos_Asap', 'SPEI_RECO_OTHER_CONTEXT',
    'SAFT16kHz8BitStereo', 'SSFMOpenForRead', 'eWORDTYPE_DELETED',
    'SREAdaptation', 'DISPID_SPEAudioStreamOffset',
    'DISPID_SOTRemove', 'DISPID_SPIAudioStreamPosition',
    'DISPID_SPEEngineConfidence', 'DISPID_SVResume',
    'DISPID_SVESentenceBoundary', 'ISpRecognizer3', 'SVEPrivate',
    'SPPS_Unknown', 'SRSActive', 'DISPID_SRStatus', 'STCInprocServer',
    'SBONone', 'SREStateChange', 'SAFT32kHz8BitMono',
    'DISPID_SDKSetLongValue', 'DISPID_SpeechPhraseProperty',
    'SPWP_UNKNOWN_WORD_PRONOUNCEABLE', 'DISPID_SLWWord',
    'SPPHRASEPROPERTY', 'DISPID_SpeechGrammarRules',
    'DISPID_SVEBookmark', 'SPEI_ACTIVE_CATEGORY_CHANGED',
    'SREPrivate', 'SPINTERFERENCE_NONE', 'SpeechTokenContext',
    'DISPID_SPPFirstElement', 'SPGRAMMARSTATE', 'SPRST_NUM_STATES',
    'SPWF_INPUT', 'eLEXTYPE_RESERVED6', 'SP_VISEME_18',
    'ISpeechRecoGrammar', 'SPAS_STOP', 'SPRS_INACTIVE',
    'SAFTGSM610_11kHzMono', 'SpeechGrammarTagUnlimitedDictation',
    'DISPID_SRRTLength', 'DISPID_SRCSetAdaptationData',
    'ISequentialStream', 'ISpVoice', 'SPWP_KNOWN_WORD_PRONOUNCEABLE',
    'SpeechInterference', 'SPLO_DYNAMIC', 'eLEXTYPE_PRIVATE8',
    'DISPID_SRSClsidEngine', 'DISPID_SpeechRecoResult2',
    'ISpeechRecoResultDispatch', 'DISPID_SPRulesCount', 'UINT_PTR',
    'STCInprocHandler', 'ISpeechXMLRecoResult', 'DISPID_SPIRule',
    'eLEXTYPE_MORPHOLOGY', 'SAFT48kHz16BitStereo', 'SPFILEMODE',
    'SAFTNonStandardFormat', 'DISPID_SPEDisplayText',
    'ISpeechDataKey', 'ISpShortcut', 'SPEI_RECO_STATE_CHANGE',
    'SPPS_RESERVED1', 'DISPID_SpeechRecoContext',
    'SpeechPropertyAdaptationOn', 'SPSLMA', 'SPDKL_LocalMachine',
    'SAFT11kHz16BitMono', 'DISPID_SDKCreateKey', 'eLEXTYPE_PRIVATE10',
    'ISpeechRecoResultTimes', 'tagSPPROPERTYINFO',
    'ISpeechGrammarRuleStateTransition', 'DISPID_SRRTimes',
    'SPSEMANTICFORMAT', 'eLEXTYPE_APP', 'SVPOver',
    'SpeechGrammarTagWildcard', 'SSFMCreate', 'SVP_19',
    'SPSNotOverriden', 'STSF_CommonAppData', 'DISPID_SOTId',
    'eLEXTYPE_PRIVATE16', 'SPINTERFERENCE_TOOQUIET',
    'DISPID_SOTDataKey', 'DISPID_SOTGetStorageFileName',
    'DISPID_SGRsDynamic', 'DISPID_SRGetFormat', 'SRARoot',
    'SREPropertyStringChange', 'SPINTERFERENCE_TOOLOUD',
    'DISPID_SPRsCount', 'DISPID_SLWs_NewEnum', 'SAFT32kHz8BitStereo',
    'DISPID_SpeechAudioStatus', 'DISPID_SWFEExtraData',
    'DISPID_SRCEPropertyNumberChange', 'SPWORDLIST', 'SFTInput',
    'SDTReplacement', 'DISPID_SPRFirstElement', 'SVP_13',
    'DISPID_SRGDictationSetState', 'SpShortcut',
    'SPEI_START_SR_STREAM', 'SPEI_FALSE_RECOGNITION',
    'SPSTREAMFORMATTYPE', 'DISPID_SRCEPhraseStart', 'SGSDisabled',
    'eLEXTYPE_PRIVATE13', 'eLEXTYPE_PRIVATE19',
    'DISPID_SpeechMemoryStream', 'DISPID_SGRSTPropertyValue',
    'SP_VISEME_4', 'SVEBookmark', 'DISPID_SWFEChannels',
    'DISPID_SpeechAudio', 'SAFTCCITT_uLaw_22kHzMono', 'ISpEventSink',
    'SAFT12kHz16BitMono', 'SPFM_CREATE_ALWAYS', 'DISPID_SGRId',
    'DISPID_SVSLastBookmark', 'SVP_12',
    'DISPID_SGRSAddSpecialTransition', 'SpObjectTokenCategory',
    'SpMMAudioOut', 'SpeechTokenIdUserLexicon', 'SGRSTTWildcard',
    '__MIDL___MIDL_itf_sapi_0000_0020_0001', 'DISPID_SVSkip',
    'SGLexicalNoSpecialChars', 'SPRULE', 'DISPID_SpeechVoiceEvent',
    'SAFT12kHz8BitStereo', 'DISPID_SRCESoundEnd',
    'SpPhraseInfoBuilder', 'DISPID_SPPChildren',
    'SPSMF_SRGS_SEMANTICINTERPRETATION_MS', 'DISPID_SRRTStreamTime',
    'DISPID_SPIGetText', 'SPAS_CLOSED', 'SREFalseRecognition',
    'DISPID_SPPBRestorePhraseFromMemory', 'DISPID_SRCVoicePurgeEvent',
    'SLTApp', 'SPWT_PRONUNCIATION', 'SINoSignal', 'SPSModifier',
    'SPBO_PAUSE', 'DISPID_SVEAudioLevel', 'ISpeechRecognizer',
    'SP_VISEME_3', 'SPRS_ACTIVE', 'DISPID_SRGRules',
    'DISPID_SPPs_NewEnum', 'ISpeechObjectTokens',
    'SpeechStreamFileMode', 'SRCS_Disabled',
    'DISPID_SOTCEnumerateTokens', 'DISPID_SPIProperties',
    'ISpRecoCategory', 'DISPID_SRCEStartStream',
    'SPWORDPRONOUNCEABLE', 'DISPID_SPRuleParent',
    'DISPID_SWFESamplesPerSec', 'DISPID_SLWPronunciations',
    'DISPID_SLGetWords', 'SPRST_INACTIVE_WITH_PURGE',
    'DISPID_SLPPhoneIds', 'DISPID_SPIEngineId', 'SP_VISEME_1',
    'DISPID_SpeechRecoContextEvents', 'SVPAlert', 'SLTUser',
    'SRTAutopause', 'SpPhoneticAlphabetConverter',
    'Speech_Max_Pron_Length', 'SAFTCCITT_ALaw_22kHzMono',
    'SPEI_MIN_TTS', 'SPEI_WORD_BOUNDARY', 'DISPID_SOTIsUISupported',
    'SPPS_RESERVED3', 'DISPID_SLWType',
    'DISPID_SRSCurrentStreamPosition',
    'DISPID_SVSInputSentencePosition', 'DISPID_SVEStreamStart',
    'SAFT11kHz8BitMono', 'DISPID_SVGetProfiles',
    'SPINTERFERENCE_NOISE', 'ISpeechPhraseProperties',
    'DISPID_SAFType', 'ISpeechAudio', 'SAFT44kHz8BitStereo',
    'SINoise', 'DISPID_SPIGrammarId', 'SPWORD',
    'ISpPhoneticAlphabetSelection', 'SAFTCCITT_ALaw_8kHzStereo',
    'DISPID_SPRs_NewEnum', 'DISPID_SVAlertBoundary',
    'ISpeechPhraseProperty', 'SSFMCreateForWrite', 'SRCS_Enabled',
    'DISPID_SPILanguageId', 'SPWT_LEXICAL', 'DISPID_SVEVoiceChange',
    'SPADAPTATIONRELEVANCE', 'DISPID_SDKSetBinaryValue',
    'SDTPronunciation', 'DISPID_SGRSTType', 'SVSFParseSsml',
    'DISPID_SpeechGrammarRule', 'SPEI_PHRASE_START',
    'DISPID_SPRDisplayAttributes', 'SDKLCurrentConfig',
    'SAFT48kHz8BitStereo', 'DISPID_SpeechBaseStream', 'SVP_20',
    'SPEI_SR_PRIVATE', 'SPTEXTSELECTIONINFO', 'SpeechCategoryVoices',
    'SpeechTokenKeyFiles', 'DISPID_SGRSTPropertyId',
    'IEnumSpObjectTokens', 'SAFTCCITT_uLaw_44kHzMono',
    'SAFTADPCM_11kHzMono', 'SPEI_RECOGNITION', 'DISPID_SFSClose',
    'ISpeechFileStream', 'SPAR_Unknown',
    'DISPID_SPERetainedSizeBytes', 'SAFT44kHz16BitStereo',
    'SPAUDIOOPTIONS', 'SVPNormal', 'DISPID_SRRGetXMLResult',
    'DISPID_SGRsAdd', 'DISPID_SVEPhoneme', 'DISPID_SRRAudio',
    'SpeechAudioFormatGUIDText', 'SpeechWordPronounceable',
    'DISPID_SpeechRecoResultTimes', 'DISPID_SAFGuid',
    'SAFTCCITT_uLaw_22kHzStereo', 'SPEVENT', 'SPEI_SOUND_END',
    'SPFM_NUM_MODES', 'SPCS_DISABLED', 'SPEI_SR_BOOKMARK',
    'ISpeechPhraseAlternate', 'SECFNoSpecialChars', 'SPSHT_OTHER',
    'SASStop', 'SAFTCCITT_ALaw_22kHzStereo', 'DISPID_SRCBookmark',
    'eLEXTYPE_PRIVATE3', 'SGPronounciation', 'SECFDefault',
    'DISPID_SPCIdToPhone', 'SPSERIALIZEDRESULT',
    'DISPID_SLGenerationId', 'DISPID_SVSLastStreamNumberQueued',
    'SPEI_START_INPUT_STREAM', 'SpStreamFormatConverter',
    'SpeechRunState', 'ISpeechCustomStream', 'DISPID_SVPause',
    'SPSInterjection', 'SPEI_MIN_SR', 'SpNullPhoneConverter',
    'DISPID_SPIElements', 'ISpeechPhraseElement',
    'SAFTADPCM_11kHzStereo', 'SP_VISEME_9', 'eLEXTYPE_PRIVATE9',
    'DISPID_SRRRecoContext', 'ISpNotifyTranslator',
    'DISPID_SpeechPhraseReplacements', 'LONG_PTR',
    'DISPID_SPEAudioTimeOffset', 'SPPROPERTYINFO', 'SRERecognition',
    'SSSPTRelativeToStart', 'eLEXTYPE_RESERVED9',
    'DISPID_SVSPhonemeId', 'SAFTCCITT_uLaw_11kHzMono',
    'eLEXTYPE_RESERVED4', 'DISPID_SPIGetDisplayAttributes',
    'DISPID_SVPriority', 'ISpeechRecoContext', 'ISpLexicon',
    'DISPID_SLPsItem', 'DISPID_SpeechVoiceStatus',
    'ISpeechRecognizerStatus', 'DISPID_SBSSeek',
    'DISPID_SpeechPhraseInfo', 'SPVPRIORITY',
    'DISPID_SRCRetainedAudioFormat', 'DISPID_SRCEFalseRecognition',
    'SpeechStreamSeekPositionType', 'DISPID_SPAsItem', 'SREStreamEnd',
    'SPPS_RESERVED4', 'DISPID_SABIBufferSize', 'SITooLoud',
    'SPRST_ACTIVE_ALWAYS', 'SpFileStream', 'SPGS_DISABLED',
    'SPRECORESULTTIMES', 'DISPID_SRGRecoContext', 'SRESoundEnd',
    'SpeechPartOfSpeech', 'SWPUnknownWordUnpronounceable',
    'SRATopLevel', 'DISPID_SLPSymbolic', 'DISPID_SRCVoice',
    'SAFT8kHz16BitStereo', 'SRAONone', 'DISPID_SGRs_NewEnum',
    'SSSPTRelativeToEnd', 'SpeechAudioFormatType',
    'DISPID_SRCEAudioLevel', 'SPWT_LEXICAL_NO_SPECIAL_CHARS',
    'SPCT_SUB_DICTATION', 'SpeechRetainedAudioOptions',
    'SpeechVisemeType', 'ISpRecognizer2',
    'DISPID_SOTMatchesAttributes', 'ISpRecognizer', 'ISpMMSysAudio',
    'DISPID_SpeechObjectToken', 'SAFTDefault',
    'DISPID_SGRSAddRuleTransition', 'DISPID_SPRuleChildren', 'SVP_14',
    'DISPID_SRRSaveToMemory', 'SPPS_Noncontent', 'DISPID_SPAsCount',
    'SLOStatic', 'SAFTCCITT_ALaw_44kHzMono', 'DISPID_SVEViseme',
    'DISPID_SRGetPropertyString', 'DISPID_SVSInputWordLength',
    'SPBOOKMARKOPTIONS', 'SpeechEngineProperties', 'SRAExport',
    'DISPID_SADefaultFormat', 'SPEI_RESERVED5',
    'SAFTCCITT_uLaw_8kHzMono', 'ISpeechPhraseRules',
    'DISPID_SpeechWaveFormatEx', 'DISPID_SRGetRecognizers',
    'DISPID_SRCRetainedAudio', 'eLEXTYPE_PRIVATE4',
    'SAFT44kHz8BitMono', 'SpNotifyTranslator', 'SPCONTEXTSTATE',
    'SPCT_DICTATION', 'SASRun',
    'DISPID_SLRemovePronunciationByPhoneIds', 'DISPID_SVEWord',
    'DISPID_SRCCreateGrammar', 'DISPID_SpeechPhraseElement',
    'SPAR_High', 'DISPID_SPRText', 'SAFT16kHz16BitStereo',
    'eLEXTYPE_PRIVATE7', 'SpeechSpecialTransitionType',
    'SPEI_REQUEST_UI', 'DISPID_SPACommit', 'eLEXTYPE_PRIVATE1',
    'SPAR_Low', 'DISPID_SPEDisplayAttributes', 'DISPID_SpeechDataKey',
    'SpeechAudioProperties', 'SAFTExtendedAudioFormat', 'IEnumString',
    'ISpeechPhraseInfo', 'SPVOICESTATUS', 'SPSMF_UPS', 'SPCS_ENABLED',
    'SGDSActive', 'DISPID_SABIEventBias',
    'DISPID_SRSNumberOfActiveRules', 'SpSharedRecognizer',
    'DISPID_SWFEBitsPerSample', 'DISPID_SpeechPhraseElements',
    'SPEI_SENTENCE_BOUNDARY', 'SpeechBookmarkOptions',
    'SPEI_END_SR_STREAM', 'SVP_11', 'SAFTADPCM_8kHzStereo',
    'DISPID_SVVolume', 'ISpeechPhraseReplacement', 'DISPID_SRGId',
    'DISPID_SASFreeBufferSpace', 'eLEXTYPE_PRIVATE2',
    'DISPID_SDKOpenKey', 'SAFT12kHz8BitMono', 'SPLO_STATIC',
    'DISPID_SpeechPhraseProperties', 'DISPID_SRGCommit',
    'DISPID_SPPEngineConfidence', 'SRSEIsSpeaking', 'SVSFDefault',
    'ISpObjectTokenCategory', 'eLEXTYPE_PRIVATE11',
    'ISpeechVoiceStatus', 'SpeechCategoryAudioIn',
    'SPEI_PROPERTY_NUM_CHANGE', 'SVSFParseMask', 'SPLEXICONTYPE',
    'DISPID_SVGetAudioInputs', 'DISPID_SOTDisplayUI',
    'SpeechTokenValueCLSID', 'DISPID_SRAudioInputStream', 'SGDisplay',
    'DISPID_SPEsItem', 'SpeechVoicePriority', 'ISpeechVoice',
    'DISPID_SLRemovePronunciation', 'DISPID_SVSRunningState',
    'SpeechPropertyNormalConfidenceThreshold', 'ISpNotifySink',
    'DISPID_SABufferInfo', 'ISpeechPhraseReplacements',
    'DISPID_SLWsItem', 'DISPID_SDKEnumKeys',
    'DISPID_SAFGetWaveFormatEx', 'DISPID_SOTsCount',
    'DISPID_SOTRemoveStorageFileName',
    'DISPID_SRAllowAudioInputFormatChangesOnNextSet',
    'eLEXTYPE_LETTERTOSOUND', 'DISPID_SRCEInterference',
    'DISPID_SpeechRecoResult', 'ISpeechGrammarRuleStateTransitions',
    'SpeechGrammarTagDictation', 'SVP_6',
    'DISPID_SpeechLexiconPronunciation', 'SPSERIALIZEDPHRASE',
    'ISpeechRecoResult2', 'SPWORDTYPE', 'SECLowConfidence',
    'SPCATEGORYTYPE', 'SDTLexicalForm', 'DISPID_SPEAudioSizeTime',
    'DISPID_SpeechLexicon', 'SREBookmark', 'SpeechRuleState',
    'DISPID_SGRSTNextState', 'DISPID_SRState', 'SECHighConfidence',
    '_RemotableHandle', 'SP_VISEME_15', 'DISPID_SLPsCount',
    'SPSUnknown', 'SAFTTrueSpeech_8kHz1BitMono', 'SPPS_NotOverriden',
    'DISPID_SVEStreamEnd', 'SRADefaultToActive', 'SpAudioFormat',
    'SRSEDone', 'SVP_10', 'DISPID_SRGDictationUnload', 'ISpPhraseAlt',
    'SPEI_VOICE_CHANGE', 'SPPS_Function',
    'DISPID_SPPNumberOfElements', 'SpeechDictationTopicSpelling',
    'SpeechCategoryPhoneConverters', 'DISPID_SOTs_NewEnum',
    'SAFTGSM610_8kHzMono',
    'DISPID_SVAllowAudioOuputFormatChangesOnNextSet', 'SVP_8',
    'SpPhoneConverter', 'DISPID_SpeechPhraseRules', 'SPPS_Noun',
    'SAFTGSM610_22kHzMono', 'SpeechCategoryRecognizers',
    'DISPID_SAVolume', 'SITooFast', 'DISPIDSPTSI_SelectionLength',
    'SAFT8kHz16BitMono', 'eLEXTYPE_USER_SHORTCUT',
    'DISPID_SVSVisemeId', 'SVSFNLPMask', 'ISpeechGrammarRule',
    'SAFTADPCM_44kHzStereo', 'SPDKL_DefaultLocation',
    'SVSFPurgeBeforeSpeak', 'SVP_16',
    'DISPID_SRCERecognitionForOtherContext', 'SPPS_Verb',
    'SSTTTextBuffer', 'DISPID_SpeechCustomStream',
    'eLEXTYPE_PRIVATE20', 'SPCT_SUB_COMMAND', 'ISpStream',
    'DISPID_SVWaitUntilDone', 'DISPID_SRGCmdSetRuleState',
    'DISPID_SMSSetData', 'SpeechDataKeyLocation', 'SpeechAudioState',
    'SPAO_RETAIN_AUDIO', 'DISPID_SDKSetStringValue',
    'ISpeechAudioBufferInfo', 'SPEI_PROPERTY_STRING_CHANGE',
    'DISPID_SVEEnginePrivate', 'SWTAdded', 'DISPID_SRCState',
    'SPXRO_SML', 'SpeechVisemeFeature', 'DISPID_SPIReplacements',
    'DISPID_SASetState', 'SpeechPropertyHighConfidenceThreshold',
    'DISPID_SVSyncronousSpeakTimeout',
    'DISPID_SpeechRecognizerStatus', 'ISpeechAudioFormat',
    'SVSFlagsAsync', 'DISPID_SGRAddState',
    'ISpeechLexiconPronunciation',
    'SPWP_UNKNOWN_WORD_UNPRONOUNCEABLE', 'SpeechRecoContextState',
    'Speech_Default_Weight', 'SPPS_Interjection', 'DISPID_SPPParent',
    'DISPID_SRGCmdLoadFromResource', 'SPEI_ADAPTATION',
    'DISPID_SVSpeakCompleteEvent', 'SRTSMLTimeout', 'SGRSTTEpsilon',
    'SPAUDIOBUFFERINFO', 'SAFTADPCM_44kHzMono', 'eLEXTYPE_PRIVATE6',
    'DISPID_SRRecognizer', 'SP_VISEME_13', 'DISPID_SOTCreateInstance',
    'DISPID_SGRSTPropertyName', 'SAFT32kHz16BitStereo', 'SGRSTTWord',
    'DISPID_SRGCmdLoadFromObject', 'SP_VISEME_0', 'STSF_LocalAppData',
    'ISpeechWaveFormatEx', 'SpCompressedLexicon', 'DISPID_SGRsCount',
    'SPRECOGNIZERSTATUS', 'SVF_None', 'DISPID_SOTCSetId', 'SpLexicon',
    'SLODynamic', 'SpMMAudioIn', 'SAFTCCITT_ALaw_8kHzMono',
    'DISPID_SRRSpeakAudio', 'SpeechPropertyResourceUsage',
    'SPEI_RESERVED3', 'SPSMF_SRGS_SEMANTICINTERPRETATION_W3C',
    'DISPID_SPEsCount', 'SDTAll', 'DISPID_SGRAttributes',
    'DISPID_SRSCurrentStreamNumber', 'DISPID_SREmulateRecognition',
    'DISPID_SMSALineId', 'SDTProperty',
    'SpeechPropertyComplexResponseSpeed', 'ISpProperties',
    'SAFT32kHz16BitMono',
    'DISPID_SRAllowVoiceFormatMatchingOnNextSet',
    'DISPID_SRGDictationLoad', 'SRERecoOtherContext',
    'ISpeechTextSelectionInformation', 'ISpeechObjectTokenCategory',
    'STCLocalServer', 'SGDSInactive', 'SpInProcRecoContext',
    'ISpeechLexiconWord', 'DISPID_SRCRecognizer', 'SRSActiveAlways',
    'SPVPRI_NORMAL', 'DISPIDSPTSI_ActiveOffset',
    'DISPID_SVSpeakStream', 'SPCT_SLEEP',
    'SpeechRecoProfileProperties', 'DISPID_SLGetGenerationChange',
    'STSF_AppData', 'SPRECOCONTEXTSTATUS', 'SVEAllEvents',
    'ISpeechMemoryStream', 'SPEI_MAX_TTS',
    '__MIDL___MIDL_itf_sapi_0000_0020_0002',
    'DISPID_SPEActualConfidence', 'ISpeechPhraseElements',
    'SPINTERFERENCE_LATENCY_WARNING', 'SRSInactive', 'SDTDisplayText',
    'SPBO_NONE', 'DISPID_SVSCurrentStreamNumber',
    'SAFTCCITT_ALaw_11kHzMono', 'SAFTADPCM_22kHzMono',
    'DISPID_SpeechPhraseRule', 'DISPID_SOTSetId', 'eWORDTYPE_ADDED',
    'DISPID_SPRsItem', 'DISPID_SRCEEndStream',
    'DISPID_SGRSAddWordTransition', 'DISPID_SRRGetXMLErrorInfo',
    'ISpeechPhraseInfoBuilder', 'SpObjectToken', 'SP_VISEME_21',
    'SVP_17', 'ISpeechPhoneConverter', 'SAFTNoAssignedFormat',
    'DISPID_SVEventInterests', 'SITooQuiet', 'SRESoundStart',
    'DISPID_SRRTOffsetFromStart', 'DISPID_SRCEAdaptation',
    'SPEI_VISEME', 'SpeechPropertyLowConfidenceThreshold',
    'DISPID_SGRClear', 'SPRS_ACTIVE_WITH_AUTO_PAUSE',
    'DISPID_SPPsItem', 'DISPID_SDKGetlongValue', 'SRAInterpreter',
    'SPEVENTSOURCEINFO', 'SVP_4', 'SP_VISEME_11', 'SWTDeleted',
    'DISPID_SMSGetData', 'DISPIDSPRG', 'IInternetSecurityManager',
    'ISpeechLexicon', 'DISPID_SVVoice', 'DISPID_SPIEnginePrivateData',
    'SAFT16kHz8BitMono', 'eLEXTYPE_PRIVATE12', 'SPSVerb',
    'DISPID_SDKDeleteValue', 'SPEVENTENUM', 'SVP_9', 'SVF_Stressed',
    'SPSHORTCUTPAIR', 'DISPID_SpeechAudioBufferInfo',
    'DISPID_SGRsCommit', 'SGRSTTRule', 'DISPID_SPISaveToMemory',
    'DISPID_SWFEFormatTag', 'ISpeechGrammarRuleState',
    'DISPID_SFSOpen', 'ISpXMLRecoResult', 'SVF_Emphasis', 'SpStream',
    'SpInprocRecognizer', 'DISPID_SPIAudioSizeTime',
    'DISPID_SDKGetBinaryValue', 'eLEXTYPE_PRIVATE17',
    'DISPID_SRGCmdLoadFromMemory', 'SpeechVoiceSkipTypeSentence',
    'DISPID_SPARecoResult', 'SPVISEMES',
    'DISPID_SpeechGrammarRuleStateTransition', 'DISPID_SLPLangId',
    'SAFT24kHz16BitStereo', 'DISPID_SRCEEnginePrivate',
    'ISpStreamFormat', 'DISPID_SGRAddResource',
    'DISPID_SPRuleConfidence', 'ISpStreamFormatConverter',
    'DISPID_SVSLastResult', 'SPEI_RESERVED2', 'DISPID_SRSAudioStatus',
    'DISPID_SOTCDefault', 'DISPID_SPRulesItem', 'SPPHRASE',
    'SAFT12kHz16BitStereo', 'eLEXTYPE_PRIVATE14',
    'DISPID_SASNonBlockingIO', 'DISPID_SPRuleFirstElement',
    'SPFM_CREATE', 'DISPID_SPPConfidence', 'SpeechTokenShellFolder',
    'eLEXTYPE_USER', 'DISPID_SVGetVoices', 'SpCustomStream',
    'DISPID_SPRules_NewEnum', 'DISPID_SVSLastBookmarkId',
    'DISPID_SGRSTs_NewEnum', 'DISPID_SRCERecognizerStateChange',
    'SPPARTOFSPEECH', 'SPEI_TTS_PRIVATE', 'SpeechRecognitionType',
    'SVP_18', 'SPSHT_Unknown', 'ISpeechGrammarRules', 'SP_VISEME_2',
    'DISPID_SPEs_NewEnum', 'SPEI_HYPOTHESIS', 'SP_VISEME_6',
    'SpeechEngineConfidence', 'DISPIDSPTSI_ActiveLength',
    'DISPID_SRCEBookmark', 'DISPID_SGRSTRule',
    'DISPID_SRGetPropertyNumber', 'SREAudioLevel', 'SINone',
    'SPPS_RESERVED2', 'DISPID_SGRsFindRule', 'SVEVoiceChange',
    'ISpeechLexiconPronunciations', 'DISPID_SGRSTransitions',
    'SpeechTokenKeyAttributes', 'SREPropertyNumChange',
    'SPEI_SR_AUDIO_LEVEL', 'DISPID_SOTsItem', 'SPSFunction',
    'ISpAudio', 'SAFTCCITT_uLaw_44kHzStereo', 'SVSFParseSapi',
    'SGRSTTTextBuffer', 'SAFT22kHz8BitMono', 'SVP_5', 'SVP_7',
    'DISPID_SRCResume', 'SPSHORTCUTPAIRLIST', 'SPEI_SR_RETAINEDAUDIO',
    'DISPID_SVSInputWordPosition', 'DISPID_SRCERecognition',
    'SPPHRASEREPLACEMENT', 'SPINTERFERENCE', 'SPGS_ENABLED',
    'SPCT_COMMAND', 'DISPID_SRGCmdLoadFromProprietaryGrammar',
    'SPEI_PHONEME', 'SP_VISEME_12', 'SREPhraseStart',
    'DISPID_SRIsShared', 'SECFIgnoreCase', 'SPAS_RUN',
    'SpeechRecoEvents', 'DISPID_SRRAudioFormat',
    'SAFT22kHz8BitStereo', 'SECNormalConfidence',
    'SAFTADPCM_8kHzMono', 'SFTSREngine', 'DISPID_SBSFormat',
    'SPRST_ACTIVE', 'DISPID_SpeechAudioFormat',
    'DISPID_SPELexicalForm', 'SDTRule', 'ISpeechResourceLoader',
    'SP_VISEME_17', 'SPEI_TTS_BOOKMARK', 'DISPID_SpeechVoice',
    'SRERequestUI', 'eLEXTYPE_PRIVATE18', 'eLEXTYPE_RESERVED8',
    'SPAUDIOSTATE', 'DISPID_SWFEBlockAlign', 'ISpPhoneConverter',
    'SREHypothesis', 'SPSMF_SAPI_PROPERTIES',
    'SDA_Consume_Leading_Spaces', 'SRTEmulated', 'SVP_21',
    'SVSFNLPSpeakPunc', 'SGLexical', 'SDKLDefaultLocation',
    'ISpRecoContext', 'DISPID_SpeechPhraseReplacement',
    'SDA_No_Trailing_Space', 'SPWF_SRENGINE', 'SpeechGrammarState',
    'DISPID_SRCESoundStart', 'DISPID_SGRSTsItem', 'ISpDataKey',
    'DISPID_SGRSTWeight', 'SAFT16kHz16BitMono', 'DISPID_SPCPhoneToId',
    'DISPID_SPEPronunciation', 'SBOPause', 'SVP_2',
    'DISPID_SPEAudioSizeBytes', 'DISPID_SpeechMMSysAudio',
    'DISPID_SpeechPhraseAlternate', 'SAFTCCITT_ALaw_44kHzStereo',
    '_ISpeechRecoContextEvents', 'DISPID_SpeechFileStream',
    'SPWORDPRONUNCIATION', 'DISPID_SVSpeak',
    'DISPID_SLAddPronunciation', 'DISPID_SpeechObjectTokens',
    'DISPID_SRRSetTextFeedback', 'SVSFUnusedFlags', 'SpMMAudioEnum',
    'DISPID_SpeechGrammarRuleStateTransitions', 'SSTTWildcard',
    'ISpeechBaseStream', 'DISPID_SPRuleEngineConfidence',
    'eLEXTYPE_PRIVATE5', 'DISPID_SpeechObjectTokenCategory',
    'DISPID_SRCPause', 'DISPID_SpeechGrammarRuleState',
    'DISPID_SVStatus', 'SDA_One_Trailing_Space',
    'SPEI_END_INPUT_STREAM', 'DISPID_SRGSetWordSequenceData',
    'SPINTERFERENCE_LATENCY_TRUNCATE_BEGIN', 'ISpeechPhraseRule',
    'DISPID_SRCRequestedUIType', 'DISPID_SpeechLexiconWords',
    'DISPID_SOTCGetDataKey', 'STSF_FlagCreate', 'DISPID_SOTCategory',
    'SVEWordBoundary', 'ISpeechRecoResult', 'SpSharedRecoContext',
    'SpeechWordType', 'SVEEndInputStream', 'DISPID_SAStatus',
    'ISpPhoneticAlphabetConverter', 'SPDKL_CurrentUser',
    'SPWORDPRONUNCIATIONLIST', 'DISPID_SABIMinNotification',
    'SAFT44kHz16BitMono', 'SPFM_OPEN_READWRITE',
    'SAFTCCITT_ALaw_11kHzStereo', 'eLEXTYPE_RESERVED10',
    'SpeechMicTraining', 'SVEAudioLevel',
    'SPINTERFERENCE_LATENCY_TRUNCATE_END', 'DISPID_SAEventHandle',
    'SpeechRegistryUserRoot', 'DISPID_SLAddPronunciationByPhoneIds',
    'SAFT8kHz8BitMono', 'SpTextSelectionInformation',
    '_ISpeechVoiceEvents', 'SAFTADPCM_22kHzStereo',
    'SPEI_INTERFERENCE', 'SPEI_RESERVED6', 'ISpRecoGrammar',
    'DISPID_SBSWrite', 'DISPID_SVRate', 'SVSFIsFilename',
    'DISPID_SPRNumberOfElements', 'DISPID_SPIRetainedSizeBytes',
    'SP_VISEME_10', 'SRAORetainAudio', 'ISpRecoGrammar2',
    'DISPID_SRCAudioInInterferenceStatus', 'ISpeechObjectToken',
    'DISPID_SLPType', 'ISpeechPhraseAlternates', 'SPPHRASEELEMENT',
    'SDKLLocalMachine', 'SPLOADOPTIONS', 'DISPID_SpeechRecognizer',
    'DISPID_SPIStartTime', 'SPBINARYGRAMMAR', '__MIDL_IWinTypes_0009',
    'ISpEventSource', 'SPRULESTATE', 'SPEI_TTS_AUDIO_LEVEL',
    'SpeechGrammarRuleStateTransitionType', 'SVP_15',
    'SpMemoryStream', 'SpeechUserTraining', 'SPINTERFERENCE_NOSIGNAL',
    'tagSTATSTG', 'DISPID_SRRAlternates',
    'DISPID_SRCCmdMaxAlternates', 'SPXMLRESULTOPTIONS',
    'DISPID_SPERetainedStreamOffset', 'SPWAVEFORMATTYPE',
    'ISpObjectWithToken', 'SpeechGrammarWordType',
    'DISPID_SOTGetAttribute', 'SGSExclusive', 'STCAll',
    'SPSHT_NotOverriden', 'SRADynamic', 'SRTStandard',
    'DISPID_SRGIsPronounceable', 'ISpRecoContext2', 'SREStreamStart',
    'DISPID_SGRName', 'SPSHORTCUTTYPE', 'SGDSActiveWithAutoPause',
    'SRSInactiveWithPurge', 'SVSFPersistXML', 'eLEXTYPE_PRIVATE15',
    'SpeechVoiceSpeakFlags', 'SWPKnownWordPronounceable',
    'DISPID_SVSInputSentenceLength', 'SPSSuppressWord',
    'SpUnCompressedLexicon', 'SRTReSent', 'DISPID_SLPPartOfSpeech',
    'SPSMF_SRGS_SAPIPROPERTIES', 'SECFEmulateResult',
    'SpeechCategoryRecoProfiles', 'DISPID_SRRPhraseInfo',
    'SREAllEvents', 'SVP_1', 'SP_VISEME_8', 'SPINTERFERENCE_TOOFAST',
    'SpeechAudioVolume', 'SVEStartInputStream', 'SVP_0',
    'DISPID_SRGCmdSetRuleIdState', 'DISPID_SPPName',
    'SAFT8kHz8BitStereo', 'SpeechLoadOption', 'DISPID_SOTCId',
    'SPEI_UNDEFINED', 'DISPID_SBSRead',
    'DISPID_SPAStartElementInResult',
    'SpeechRegistryLocalMachineRoot', 'SASPause', 'SP_VISEME_14',
    'SpeechAudioFormatGUIDWave', 'Speech_StreamPos_RealTime',
    'SDTAlternates', 'SDTAudio', 'SpeechCategoryAudioOut',
    'SAFT24kHz8BitStereo', 'SpeechVoiceCategoryTTSRate',
    'DISPID_SLPs_NewEnum', 'SPEI_RESERVED1', 'SpResourceManager',
    'DISPID_SRRTTickCount', 'DISPID_SRCERequestUI', 'DISPID_SASState',
    'DISPIDSPTSI_SelectionOffset', 'SPXRO_Alternates_SML',
    'DISPID_SGRSRule', 'DISPID_SAFSetWaveFormatEx', 'ISpRecoResult',
    'ISpeechMMSysAudio', 'SGDSActiveUserDelimited',
    'DISPID_SGRsCommitAndSave', 'SpeechAddRemoveWord', 'SPSNoun',
    'SPAS_PAUSE', 'DISPID_SpeechPhraseBuilder',
    'DISPID_SRSetPropertyString', 'DISPIDSPTSI',
    'DISPID_SpeechXMLRecoResult', 'SPBO_TIME_UNITS',
    'DISPID_SRGCmdLoadFromFile', 'SSSPTRelativeToCurrentPosition',
    'SPGS_EXCLUSIVE', 'SPDKL_CurrentConfig', 'DISPID_SPAPhraseInfo',
    'DISPID_SVAudioOutputStream', 'DISPID_SVGetAudioOutputs',
    'SP_VISEME_19', 'DISPID_SRProfile', 'SPPS_SuppressWord',
    'SITooSlow', 'SRAImport', 'DISPID_SASCurrentDevicePosition',
    'SAFTCCITT_uLaw_8kHzStereo', 'SVSFVoiceMask', 'SGRSTTDictation',
    'SPINTERFERENCE_TOOSLOW', 'DISPID_SVIsUISupported',
    'SPPS_Modifier', 'SpeechPropertyResponseSpeed',
    'DISPID_SWFEAvgBytesPerSec', 'SVEViseme', 'SP_VISEME_20',
    'SpeechRecognizerState', 'DISPID_SVDisplayUI',
    'DISPID_SMSAMMHandle', 'DISPID_SRAudioInput',
    'SAFT11kHz8BitStereo', 'tagSPTEXTSELECTIONINFO',
    'DISPID_SRCreateRecoContext', 'SAFTText', 'SECFIgnoreWidth',
    'SDA_Two_Trailing_Spaces', 'SAFT24kHz8BitMono',
    'SPRS_ACTIVE_USER_DELIMITED', 'SASClosed', 'SREInterference',
    'DISPID_SPERequiredConfidence', 'DISPID_SOTGetDescription',
    'ISpPhrase', 'ISpObjectToken', 'eLEXTYPE_VENDORLEXICON',
    'SRTExtendableParse', 'DISPID_SGRSTText', 'ISpNotifySource',
    'DISPID_SDKGetStringValue', 'DISPID_SpeechPhoneConverter',
    'SAFTGSM610_44kHzMono', 'SVSFIsNotXML', 'SSTTDictation',
    'SPRECOSTATE', 'SVEPhoneme', 'DISPID_SRDisplayUI',
    'SpeechLexiconType', 'IInternetSecurityMgrSite', 'SPRST_INACTIVE',
    'DISPID_SLGetPronunciations', 'DISPID_SGRInitialState',
    'DISPID_SPPValue', 'DISPID_SVAudioOutput', 'DISPID_SGRsItem',
    'SPEI_SOUND_START', 'DISPID_SRSSupportedLanguages',
    'SpeechRuleAttributes', 'SPSEMANTICERRORINFO',
    'DISPID_SCSBaseStream', 'DISPID_SRGReset', 'SAFT11kHz16BitStereo',
    'SpeechTokenKeyUI', 'DISPID_SpeechLexiconProns',
    'SpeechDisplayAttributes', 'SpeechDiscardType',
    'DISPID_SRSetPropertyNumber', 'DISPID_SRCCreateResultFromMemory',
    'DISPID_SPIAudioSizeBytes', 'DISPID_SPRuleName',
    'SSFMOpenReadWrite', 'SPBO_AHEAD', 'SP_VISEME_5',
    'Speech_Max_Word_Length', 'SVP_3', 'SpeechFormatType',
    'SPAR_Medium', 'SpeechCategoryAppLexicons', 'DISPID_SDKDeleteKey',
    'DISPID_SRGSetTextSelection', 'IStream', 'DISPID_SPAs_NewEnum',
    '_SPAUDIOSTATE', 'SAFT24kHz16BitMono',
    'DISPID_SPANumberOfElementsInResult', 'DISPID_SMSADeviceId',
    'SpWaveFormatEx', 'SDKLCurrentUser', 'DISPID_SPPsCount',
    'SPDATAKEYLOCATION', 'SVESentenceBoundary', 'ISpGrammarBuilder',
    'SPAUDIOSTATUS', 'SP_VISEME_16'
]

_check_version('1.2.0', 1700060352.184451)
